...
ᴋᴇᴛɪᴋ ${prefix}daftar ᴜɴᴛᴜᴋ ᴍᴇᴍᴜʟᴀɪ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '*⏳ SABAR SEDANG DI PROSES ANJJ...*',
				success: '*ꜱᴜᴋꜱᴇꜱ...*',
				error: {
			...
			const ownerNumber = ["6285866295942@s.whatsapp.net","6289560503079@s.whataapp.net"] // owner number ubah aja
...
case 'husbu':
		...
		if (budy.includes(`Thanks`)) {
                  ...
                  reply(`ʜᴀʟʟᴏ ᴋᴀᴋ *${pushname2}*, junn ᴅɪꜱɪɴɪ ᴀᴅᴀ ʏᴀɴɢ ʙɪꜱᴀ ᴅɪʙᴀɴᴛᴜ? ᴋᴇᴛɪᴋ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
			      if (budy.includes(`Dns`)) {
                  reply(`ʜᴀʟʟᴏ ᴋᴀᴋ *${pushname2}*, junn ᴅɪꜱɪɴɪ ᴀᴅᴀ ʏᴀɴɢ ʙɪꜱᴀ ᴅɪʙᴀɴᴛᴜ? ᴋᴇᴛɪᴋ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
